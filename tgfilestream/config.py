...
try:
    api_id = int(os.environ["TG_API_ID", "5310709"])
    api_hash = os.environ["TG_API_HASH", "63a546bdaf18e2cbba99f87b4274fa05"]
...
bot_token = os.environ.get("BOT_TOKEN", "5462641835:AAHBBA7u2XTcqP1uusarSxDAHhXCjH1Z940")
